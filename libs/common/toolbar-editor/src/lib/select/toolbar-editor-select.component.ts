...
@Component({
  selector: 'toolbar-editor-select',
  templateUrl: './toolbar-editor-select.component.html',
  styleUrls: ['./toolbar-editor-select.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ToolbarEditorSelectComponent),
      multi: true,
    },
  ],
})
export class ToolbarEditorSelectComponent
