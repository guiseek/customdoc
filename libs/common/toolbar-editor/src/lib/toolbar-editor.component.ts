...
import { ToolbarEditorConfig, toolbarEditorConfig } from './config';
import { ToolbarEditorRowComponent } from './row/toolbar-editor-row.component';
import { isDefined } from './utils';

@Component({
  selector: 'toolbar-editor',
  templateUrl: './toolbar-editor.component.html',
  styleUrls: ['./toolbar-editor.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ToolbarEditorComponent),
      multi: true,
    },
...
export class ToolbarEditorComponent
  ...
  @Input() id = '';
  @Input() config: ToolbarEditorConfig = toolbarEditorConfig;
  @Input() placeholder = '';
  ...
  @ViewChild('editorToolbar', { static: false }) editorToolbar: ToolbarEditorRowComponent;
  ...
  constructor(
    private r: Renderer2,
    private editorService: ToolbarEditorService,
  ...
  ngOnInit() {
    this.config.toolbarPosition = this.config.toolbarPosition
      ...
      : toolbarEditorConfig.toolbarPosition;
  }
  ...
  onTextAreaBlur(event: FocusEvent) {
    ...
    if (event.relatedTarget !== null) {
      ...
      if (
        !parent.classList.contains('toolbar-editor-toolbar-set') &&
